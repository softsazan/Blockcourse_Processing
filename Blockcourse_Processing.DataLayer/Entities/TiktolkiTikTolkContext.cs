...
public partial class TiktolkiTikTolkContext : DbContext
{
    public TiktolkiTikTolkContext()
    {
    }

    public TiktolkiTikTolkContext(DbContextOptions<TiktolkiTikTolkContext> options)
        : base(options)
    {
    }
